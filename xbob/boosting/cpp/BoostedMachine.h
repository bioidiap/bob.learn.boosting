#ifndef XBOB_BOOSTING_BOOSTED_MACHINE_H
#define XBOB_BOOSTING_BOOSTED_MACHINE_H
...
class BoostedMachine{
  public:
    ...
    void add_weak_machine1(const boost::shared_ptr<WeakMachine> weak_machine, const double weight);
    // adds the multi-variate weak machine with the given weights per output
    void add_weak_machine2(const boost::shared_ptr<WeakMachine> weak_machine, const blitz::Array<double,1> weights);
...
#endif // XBOB_BOOSTING_BOOSTED_MACHINE_H
