...
static auto lossFunction_doc = xbob::extension::ClassDoc(
  "LossFunction",
  ...
  ".. code-block:: py\n\n"
  "   loss = xbob.boosting.loss.JesorskyLoss()\n"
  ...
  "Please see the code of :py:class:`xbob.boosting.trainer.Boosting` for an example."
);


static auto lossFunction_lossSum_doc = xbob::extension::FunctionDoc(
  "loss_sum",
...
static auto lossFunction_gradientSum_doc = xbob::extension::FunctionDoc(
  "loss_gradient_sum",
